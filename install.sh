...
main() {
    ...
    mv ./macsploit.dylib "$HOME/Documents/Roblox.app/Contents/MacOS/macsploit.dylib"
    ./insert_dylib "$HOME/Documents/Roblox.app/Contents/MacOS/macsploit.dylib" "$HOME/Documents/Roblox.app/Contents/MacOS/RobloxPlayer" --strip-codesig --all-yes
    mv "$HOME/Documents/Roblox.app/Contents/MacOS/RobloxPlayer_patched" "$HOME/Documents/Roblox.app/Contents/MacOS/RobloxPlayer"
    rm -r "$HOME/Documents/Roblox.app/Contents/MacOS/RobloxPlayerInstaller.app"
    rm ./insert_dylib
